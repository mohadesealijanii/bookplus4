        ...
        <div className="flex-1 min-w-0 hidden md:block lg:block mr-10">
          <div className="text-wrap h-full min-h-max ">
            <div className="p-20 bg-ocean h-full rounded-tl-3xl rounded-br-3xl text-white">
              Lorem ipsum odor amet, consectetuer adipiscing elit. Curae semper
              orci sodales nostra proin facilisis vel. Urna vitae massa
              sollicitudin sit blandit mus. Neque velit per mus ultricies
              euismod elit. Massa nascetur sagittis mauris taciti dui luctus.
              Mollis per praesent placerat odio potenti.
            </div>
          </div>
        </div>
